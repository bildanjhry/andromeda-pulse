...
export default function Herro(){
  return(
    <header id="herro" className=" h-[420px] flex flex-row w-full [background:var(--gradient-herro-bg)]">
      <section className="w-[50%] flex justify-end">
        <div className="w-[83%] h-full  flex-col justify-center pr-[15%] 
          ...
          <button className="border-none rounded-xl bg-(--content-bg) h-[48px] 
					w-[163px] flex gap-2 justify-center items-center cursor-pointer">
            <p className="text-(--text-high) text-sm">Lihat Promo</p>
            <img src={ArrowRight} alt="promo" />
          </button>
        </div>
      </section>
      <section className="w-[50%] overflow-hidden relative box-border ">
        <img
